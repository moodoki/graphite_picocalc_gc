...
| 6.4: Desktop target (Linux + macOS) | **In progress — accepted 2026-08-28** | The shared `src/` tree built as a native application, in two forms: a headless renderer that writes screens to image files for the docs and for CI, and an SDL window for interactive work. Measured feasible before drafting — 98 of 101 portable sources and 136 of 136 MicroPython files already compile natively. Closes [#33](https://github.com/moodoki/graphite_picocalc_gc/issues/33) and [#42](https://github.com/moodoki/graphite_picocalc_gc/issues/42). [Spec](docs/phases/phase6.4-spec.md) |
