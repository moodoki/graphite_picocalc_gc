...
4. **Subscript-x glyph (4D.4)**: slot 141 (U+2093) baked into all five
   ...
   (the four non-Spleen scripts fetch their font sources). `gfx::
   kGlyphSubX`; the stats 1-Var output now shows `Sₓ`/`σₓ` (2-Var
