...
# The 5x8 small font stays plain ASCII (32..126); math glyphs render
# blank there, matching how pi has always been 8x16-only.
...
python3 scripts/bdf_to_utft.py drivers/spleen/spleen-5x8.bdf spleen5x8 \
    --first 32 --last 126 > src/gfx/fonts/spleen5x8.h
