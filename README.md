...
**[Download v0.5.0](https://github.com/moodoki/graphite_picocalc_gc/releases/latest)**
...
> and a programmable app platform. **Phases 0 through 6 are done and
> hardware-verified on both boards** — `v0.5.0`, 2026-08-23. Phase 6 added an
> app launcher, a shared text editor, a file browser with move/rename/delete,
> Notepad, and **MicroPython, embedded and running on the device**. You can
> write a Python script on the calculator, run it, and `import calc` to
> evaluate expressions, read and write the calculator's variables, call the
> CAS, plot and analyse graphs, reach the calculator's lists and matrices,
> list and read and write files, and draw on the screen and read keys. A
> script folder dropped under `/picocalc/apps/` becomes its own launcher
> tile. Full breakdown in [ROADMAP.md](ROADMAP.md).
